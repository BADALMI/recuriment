      ...
      <section className="py-12 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-12 text-center">About NASG</h1>

            <div className="space-y-8 lg:space-y-10">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Who We Are</h2>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  NASG is a recruitment agency based in the United States that connects professionals with employers across North America. We work with companies of all sizes and focus on long term matches rather than quick placements.
                </p>
      ...
      <section className="py-12 lg:py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-lg text-gray-600 mb-12">How NASG works for you</p>

            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                When you join NASG, you are not just another profile in a database. You create a genuine professional presence and share your background with our team. We review your resume carefully and take the time to understand what matters to you in your next role.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <section className="py-12 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-lg text-gray-600 mb-12">How NASG supports your hiring</p>

            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                Hiring takes time and effort. NASG helps by giving you access to a qualified pool of candidates who have already been screened and vetted by our team. When you need to fill a role, we review candidate profiles and resumes carefully to identify people who genuinely fit what you are looking for.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  "NASG helped me secure an actuarial role within two weeks. Their consultants took the time to understand my technical background and career goals, and the interview process was well structured and smooth. I’m extremely satisfied with the role I’ve joined."
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  "As a growing tech-driven company, hiring skilled data professionals at scale was a challenge. NASG provided a pre-screened pool of candidates who matched both our technical requirements and team culture. We successfully hired three strong team members through their process."
                </p>
                <div className="flex items-center space-x-3">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  "I was relocating internationally and concerned about finding the right role. The NASG team guided me through actuarial and data opportunities across multiple countries and helped me secure a position that exceeded my expectations. Their professionalism and support throughout the process were outstanding."
                </p>
                <div className="flex items-center space-x-3">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-8 lg:mb-12">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-lg lg:text-xl font-bold">NASG</span>
              </div>
